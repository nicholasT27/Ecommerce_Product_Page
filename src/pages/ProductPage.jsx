...
export default function ProductPage() {
  ...
  return <main className="lg:max-w-[1110px] mx-auto grid grid-cols-1 lg:grid-cols-2 lg:gap-[125px] lg:px-6 lg:py-24"><ProductGallery key={product.id} product={product} /><div className="px-6 py-8 lg:p-0 flex"><ProductDetails product={product} /></div></main>;
}
